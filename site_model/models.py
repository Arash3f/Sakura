...
class Private_Site_Information(models.Model):
    ...
    # part one (img) :
    logo = models.ImageField(verbose_name="عکس" ,upload_to = 'logo/', blank=True , null = True)
    sign_one = models.ImageField(verbose_name="عکس" ,upload_to = 'sign/', blank=True , null = True)
    sign_two = models.ImageField(verbose_name="عکس" ,upload_to = 'sign/', blank=True , null = True)
